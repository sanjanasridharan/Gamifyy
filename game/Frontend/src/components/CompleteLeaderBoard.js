       ...
       <div>
          ...
          {/* <h1>{reward[0].rewardpoints}</h1> */}
            <div className="wrapper1" >
                <div className="boxx1">
                    <center>
                    <h2 style={{marginBottom:40,fontFamily:"Brush Script MT, Brush Script Std, cursive",fontSize:18}}>Global Ranking</h2>
                    </center>
                ...
                <div className="boxx2">
                    <center><h2 style={{marginBottom:40,fontFamily:"Brush Script MT, Brush Script Std, cursive",fontSize:18}}>Group Ranking</h2></center>
                    <h1>  </h1>
